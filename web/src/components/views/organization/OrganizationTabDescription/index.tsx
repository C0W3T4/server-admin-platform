...
export const OrganizationTabDescription = ({
  defaultValues,
}: DetailsViewProps<OrganizationDataProps>) => {
              ...
              <Stack spacing={2}>
                ...
                >
                  <Typography variant="subtitle1" sx={labelSX}>
                    <FormattedMessage id="organizations.labels.name" />
                    &#58;
                  </Typography>
                ...
                {defaultValues?.description && (
                  ...
                  >
                    <Typography variant="subtitle1" sx={labelSX}>
                      <FormattedMessage id="organizations.labels.description" />
                      &#58;
                    </Typography>
                    <Typography variant="body2" sx={infoSX}>
                      {defaultValues.description}
                ...
                >
                  <Typography variant="subtitle1" sx={labelSX}>
                    <FormattedMessage id="organizations.labels.createdAt" />
                    &#58;
                  </Typography>
                  <Typography variant="body2" sx={infoSX}>
                ...
                >
                  <Typography variant="subtitle1" sx={labelSX}>
                    <FormattedMessage id="organizations.labels.lastModifiedAt" />
                    &#58;
                  </Typography>
                  <Typography variant="body2" sx={infoSX}>
                    <DateRangeTwoTone sx={iconSX} color="info" />
                ...
                >
                  <Typography variant="subtitle1" sx={labelSX}>
                    <FormattedMessage id="organizations.labels.createdBy" />
                    &#58;
                  </Typography>
                  <Typography variant="body2" sx={infoSX}>
                ...
                >
                  <Typography variant="subtitle1" sx={labelSX}>
                    <FormattedMessage id="organizations.labels.lastModifiedBy" />
                    &#58;
                  </Typography>
                  <Typography variant="body2" sx={infoSX}>
