...
export const TeamTabDescription = ({
  defaultValues,
}: DetailsViewProps<TeamDataProps>) => {
              ...
              <Stack spacing={2}>
                ...
                >
                  <Typography variant="subtitle1" sx={labelSX}>
                    <FormattedMessage id="teams.labels.name" />
                    &#58;
                  </Typography>
                ...
                {defaultValues?.description && (
                  ...
                  >
                    <Typography variant="subtitle1" sx={labelSX}>
                      <FormattedMessage id="teams.labels.description" />
                      &#58;
                    </Typography>
                    <Typography variant="body2" sx={infoSX}>
                      {defaultValues.description}
                ...
                >
                  <Typography variant="subtitle1" sx={labelSX}>
                    <FormattedMessage id="teams.labels.createdAt" />
                    &#58;
                  </Typography>
                  <Typography variant="body2" sx={infoSX}>
                ...
                >
                  <Typography variant="subtitle1" sx={labelSX}>
                    <FormattedMessage id="teams.labels.lastModifiedAt" />
                    &#58;
                  </Typography>
                  <Typography variant="body2" sx={infoSX}>
                    <DateRangeTwoTone sx={iconSX} color="info" />
                ...
                >
                  <Typography variant="subtitle1" sx={labelSX}>
                    <FormattedMessage id="teams.labels.createdBy" />
                    &#58;
                  </Typography>
                  <Typography variant="body2" sx={infoSX}>
                ...
                >
                  <Typography variant="subtitle1" sx={labelSX}>
                    <FormattedMessage id="teams.labels.lastModifiedBy" />
                    &#58;
                  </Typography>
                  <Typography variant="body2" sx={infoSX}>
