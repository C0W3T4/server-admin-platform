...
import { BASE_PATH, DASHBOARD_PATH } from '../../configs/defaultConfig'
import { gridSpacing } from '../../libs/redux/constants'
import { OverrideIcon } from '../../types'
import { NavItemType, NavItemTypeObject } from '../../types/menu'
...
export const Breadcrumb = ({
  ...
  const separatorIcon = separator ? (
    <SeparatorIcon strokeWidth={1.5} size="16px" />
  ) : (
    <TbTallymark1 strokeWidth={1.5} size="16px" />
  )
  ...
  if (item && item.type === 'item') {
    ...
    if (item.breadcrumbs !== false) {
      breadcrumbContent = (
        <Card
          sx={{
            marginBottom: card === false ? 0 : theme.spacing(2.5),
