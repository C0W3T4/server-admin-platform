...
export const FormGroupUsers = ({
  open,
  handleCloseDialog,
  data: groupData,
  setNewData,
  oldData,
}: DialogFormProps<GroupDataProps, UsersGroupDataProps[]>) => {
  ...
  const { data } = useAxiosGet<UsersOrganizationDataProps[]>(
    `api/assigns/users-organizations/${groupData?.organization.id}/users`,
  )
                ...
                <Grid container spacing={1}>
                  <Grid item xs={12} sm={12} md={12} lg={12} xl={12}>
                    <Typography variant="subtitle1" align="left">
                      <FormattedMessage id="groups.labels.users" />
                    </Typography>
                  </Grid>
                  <Grid item xs={12} sm={12} md={12} lg={12} xl={12}>
                    <FormControl
